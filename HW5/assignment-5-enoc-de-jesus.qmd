---
title: "Analysis of 2022 World Developmental Indicators"
...
We see here that only 14 countries have no data on GDP per capita, meaning our data is a good estimator for all countries.
```{python}
gdp_null
```
